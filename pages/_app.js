...
function MyApp({ Component, pageProps }) {
  useEffect(() => {
    ...
    document.getElementById("leftsidebar__changbg--mobile").onclick = function () { functionaddclass1() };
    function functionaddclass1() {
    var element = document.getElementById("allsite");
    element.classList.toggle("allsite");
    }
  ...
  return (
    <>
      <div id="allsite">
      <div className="headermobile leftsidebar__logo">
          ...
          <div className="headermobile__right">
            <div className="headermobile__changbg" id="leftsidebar__changbg--mobile">
            ...
            <div className="open" id="openmenu">
                <span></span>
                <span></span>
                <span></span>
            </div>
